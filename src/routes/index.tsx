  ...
  head: () => ({
    meta: [
      { title: "Favour Computer Services — Computer Shop & CCTV in Nairobi" },
      {
        name: "description",
        content:
          "Premium laptops, desktops, phones, CCTV installation and live streaming services in Nairobi. Order online or pick up at F&F Building, Shop U13.",
      },
      { property: "og:title", content: "Favour Computer Services — Nairobi" },
      {
        property: "og:description",
        content: "Computers, CCTV installation and live streaming in Nairobi, Kenya.",
      },
    ],
...
function Home() {
  ...
  const ctaPrimary = {
    label: settings?.hero_cta_primary_label?.trim() || "Shop Products",
    url: settings?.hero_cta_primary_url?.trim() || "/shop",
  };
  const ctaSecondary = {
    label: settings?.hero_cta_secondary_label?.trim() || "Get a Quote",
    url: settings?.hero_cta_secondary_url?.trim() || "/contact",
  };
  ...
  return (
    <div className="flex flex-col">
      ...
      <Section
        title="Our services"
        subtitle="One technology partner for your devices, security, and events."
      >
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <ServiceCard
            Icon={ShoppingBag}
            title="Electronics Sales"
            desc="Premium new and refurbished laptops, desktops, phones and components."
            to="/shop"
            cta="Shop now"
          />
          <ServiceCard
            ...
            desc="Professional surveillance for homes, offices, schools and businesses."
            to="/cctv"
            cta="Explore CCTV"
          />
          <ServiceCard
            ...
            desc="Multi-camera streaming for church, conferences, weddings and events."
            to="/live-streaming"
            cta="Book streaming"
          />
          <ServiceCard
            ...
            desc="Consultation, repairs and ongoing IT support for individuals and teams."
            to="/contact"
            cta="Talk to us"
          />
        </div>
      ...
      <Section
        ...
        subtitle="Everything from ultralight laptops to enterprise networking."
      >
      ...
      <Section
        ...
        subtitle="Hand-picked by our staff this week."
          ...
          <div className="grid items-center gap-8 p-8 md:grid-cols-2 md:p-12">
            <div>
              ...
              <p className="mt-3 max-w-md text-background/70">
                Every device passes our 41-point inspection, ships with a 1-year warranty, and
                includes genuine accessories.
              </p>
      ...
      {/* WHY US */}
      <Section
        title="Why Favour Computer Services"
        subtitle="A Nairobi technology partner built on trust, quality, and after-sale care."
      >
        <div className="grid gap-4 md:grid-cols-3">
          <Feature
            Icon={BadgeCheck}
            t="100% Genuine"
            s="Sourced from authorized distributors and brand partners only."
          />
          <Feature
            Icon={Wrench}
            t="Tested Refurbs"
            s="Inspected, cleaned, and software-wiped before relisting."
          />
          <Feature
            Icon={ShieldCheck}
            t="Warranty included"
            s="Coverage on refurbs. Manufacturer warranty on new devices."
          />
          <Feature
            Icon={Truck}
            t="Fast delivery"
            s="Same-day across Nairobi. Countrywide shipping available."
          />
          <Feature
            Icon={Store}
            t="Store pickup"
            s="Reserve online and collect at F&F Building, Shop U13."
          />
          <Feature
            Icon={Headphones}
            t="Real support"
            s="Talk to a human via call or WhatsApp on 0726 548 592."
          />
        </div>
      </Section>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-4">
        <div className="grid items-center gap-8 overflow-hidden rounded-3xl border border-border bg-secondary p-8 md:grid-cols-2 md:p-12">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-4xl">
              Prefer picking up your order?
            </h2>
            <p className="mt-3 max-w-lg text-muted-foreground">
              Reserve products online and collect them directly from our Nairobi store at
              <span className="font-semibold text-foreground"> F&amp;F Building, Shop U13</span>,
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex h-11 items-center gap-2 rounded-full border border-border bg-background px-5 text-sm font-semibold"
              >
          ...
          <div className="grid items-center gap-6 md:grid-cols-[1fr_auto]">
            <div>
              ...
              <p className="mt-2 max-w-xl text-background/70">
                Our team helps you pick the right laptop, build a CCTV system, or plan a live
                stream.
              </p>
            </div>
      ...
      <Section title="Loved by 120,000+ customers">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            {
              n: "Maria S.",
              r: "The refurbished MacBook arrived in pristine condition. Could not tell from new.",
            },
            {
              n: "Devon K.",
              r: "Best price on a new ROG laptop, and shipping was overnight. Buying again.",
            },
            {
              n: "Priya R.",
              r: "Support actually answered the phone. Replaced my SSD without hassle.",
            },
          ].map((t) => (
            <div
              key={t.n}
              className="rounded-2xl border border-border bg-card p-6 [box-shadow:var(--shadow-card)]"
            >
        ...
        <div className="overflow-hidden rounded-3xl border border-border bg-secondary p-10 md:p-14">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Drop alerts, restock notifications, and member-only deals.
            </p>
    ...
    <section className="mx-auto mt-20 max-w-7xl px-4">
      <div className="mb-8 flex items-end justify-between gap-6">
        ...
        {action && (
          <Link
            to={action.to}
            className="hidden text-sm font-semibold text-foreground hover:underline sm:inline-flex"
          >
            {action.label} →
          </Link>
        )}
...
function ServiceCard({
  ...
  return (
    <Link
      to={to}
      className="group flex flex-col rounded-2xl border border-border bg-card p-6 transition hover:-translate-y-0.5 hover:[box-shadow:var(--shadow-card)]"
    >
