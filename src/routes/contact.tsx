  ...
  head: () => ({
    meta: [
      { title: "Contact — Favour Computer Services Nairobi" },
      {
        name: "description",
        content:
          "Contact Favour Computer Services in Nairobi. F&F Building, Shop U13 next to Odeon Cinema. Phone 0726 548 592, email bensonmurage254@gmail.com.",
      },
      { property: "og:title", content: "Contact Favour Computer Services" },
      {
        property: "og:description",
        content: "Visit our Nairobi shop, call, WhatsApp or email us.",
      },
    ...
    <div className="mx-auto max-w-7xl px-4 py-16">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-muted-foreground">
          Questions about a device, CCTV installation, or live streaming for your event? Reach out
