  ...
  head: () => ({
    meta: [
      { title: "About Us — Favour Computer Services Nairobi" },
      {
        name: "description",
        content:
          "Favour Computer Services is a trusted Nairobi-based technology company providing computers, electronics, CCTV solutions and live streaming services.",
      },
      { property: "og:title", content: "About Favour Computer Services" },
      {
        property: "og:description",
        content: "Trusted Nairobi technology partner for computers, CCTV and live streaming.",
      },
...
function AboutPage() {
  ...
  const story =
    s?.about_story ||
    "Started in the heart of Nairobi, Favour Computer Services has grown into a one-stop shop for genuine devices, professional CCTV installation, and reliable live streaming for events of every size.";
  const mission =
    s?.about_mission ||
    "To provide reliable technology products and services that empower customers through innovation, quality and exceptional support.";
  const vision =
    s?.about_vision || "To become one of Kenya's most trusted technology solution providers.";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-4 py-20 text-background md:py-28">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl">
            Trusted technology,{" "}
            <span className="text-[color:var(--accent)]">built around you.</span>
          </h1>
          <p className="mt-5 max-w-3xl text-base text-background/75 md:text-lg">
            Favour Computer Services is a Nairobi-based technology company dedicated to providing
            quality computers, electronics, CCTV solutions and professional technology services to
            individuals, businesses, schools and organizations across Kenya.
          </p>
        </div>
      </section>
...
function Info({
  ...
  const inner = (
    <div className="flex items-start gap-3">
      <span className="grid h-10 w-10 place-items-center rounded-xl bg-background">
