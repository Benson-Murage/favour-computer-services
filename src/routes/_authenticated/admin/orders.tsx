              ...
              <tr key={o.id}>
                ...
                <td className="p-3 text-xs">
                  ...
                  {o.reservation_number ? (
                    <div className="text-[10px] text-muted-foreground">{o.reservation_number}</div>
                  ) : null}
                </td>
                ...
                <td className="p-3">
                  <div className="flex items-center gap-2">
                    <Link
                      to="/receipts/$id"
                      params={{ id: o.id }}
                      className="rounded-full border border-border bg-card px-2.5 py-1 text-[11px] font-semibold hover:bg-secondary"
                    >
                      Receipt
                    </Link>
                    <Select
