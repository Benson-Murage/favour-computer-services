            ...
            {rows.map((b) => (
              <tr key={b.id}>
                ...
                <td className="p-3">
                  ...
                  <div className="text-xs text-muted-foreground">{b.event_location}</div>
                </td>
                <td className="p-3">
                ...
                <td className="p-3">
                  <StatusPill tone={tone(b.status) as never}>{b.status}</StatusPill>
                </td>
                <td className="p-3 text-right">
                  <Btn variant="ghost" onClick={() => setOpen(b)}>
                    Open
                  </Btn>
                </td>
              </tr>
        ...
        {open && (
          <div className="grid gap-4">
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                <div className="text-[10px] font-bold uppercase text-muted-foreground">Event</div>
                {open.event_type}
              </div>
              <div>
              ...
              <div className="col-span-2">
                <div className="text-[10px] font-bold uppercase text-muted-foreground">Package</div>
                {open.package}
              </div>
            </div>
            {open.requirements && (
              <div>
                ...
                <p className="mt-1 whitespace-pre-wrap text-sm">{open.requirements}</p>
              </div>
            )}
            <div>
                ...
                {STATUSES.map((s) => (
                  <Btn
                    ...
                    onClick={async () => {
                      ...
                      qc.invalidateQueries({ queryKey: ["adm", "bookings"] });
